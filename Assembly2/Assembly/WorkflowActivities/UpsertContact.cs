    ...
    public class UpsertContact : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            try
            {
                ...
                String CurrentEmailId = ContactWithUPN.FirstOrDefault() == null ? String.Empty : (String) ContactWithUPN.FirstOrDefault().EmailAddress;
                ...
                else 
                {
                    ...
                    //this update
                    if (_Lastname != null && string.IsNullOrWhiteSpace(_Lastname))
                    {
                    ...
                    else if(_Email != null && _Email.Length > 1 && CurrentEmailId != _Email)
                    {
